...
class OrbitControlsImageView extends THREE_EventDispatcher {
    constructor(camera, domElement) {
        super();
        // console.log('BEG construct OrbitControlsImageView');
        this.domElement = COL.util.isObjectValid(domElement)
            ? domElement
            : document;
        ...
        this.state = OrbitControlsImageView.STATE.NONE;
    ...
    // console.log('BEG initOrbitControlsImageViewPane');
    ...
    // console.log('BEG OrbitControlsImageView::reset()');
    ...
    update() {
        ...
        // update condition is:
        // min(camera displacement, camera rotation in radians)^2 > OrbitControlsImageView.EPS
    ...
    // console.log( 'BEG handleTwoFingerTouchMove_imageView' );
        ...
        this.deltaPoint2d_inScreenCoord_start.copy(
            this.deltaPoint2d_inScreenCoord_end
        );
        ...
        let centerPoint3d_inWorldCoord_start = COL.OrbitControlsUtils.NDC_Coord_to_WorldCoord(
            this.camera,
...
// The four arrow keys
OrbitControlsImageView.keys = { LEFT: 37, UP: 38, RIGHT: 39, BOTTOM: 40 };

// Mouse buttons
OrbitControlsImageView.mouseButtons = {
