...
`;
    ...
    onSitesChanged = async function () {
        ...
        try {
            ...
            let toastTitleStr = "Load object and material files from web server";
            let msgStr = "Failed.";
    ...
    setTopDownResizer = function () {
        ...
        {
            // console.log('foo222222222222222222222222222222222222222222222'); 
...
$(window).resize(function (event) {
    console.log('BEG ColJS resize1111111111'); 
});
